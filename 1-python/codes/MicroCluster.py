...
class MicroCluster:
    ...
    def __init__(self, labelMc, nb_points=0, identifier=0, id_list=None, linear_sum=None,
                 squared_sum=None, linear_time_sum=0, squared_time_sum=0,
                 m=100, create_timestamp=0, confidence=1):
        self.identifier = identifier
        self.create_timestamp = create_timestamp
        self.labelMc = labelMc
        self.radius = 0
        self.NumCls = 0
        self.labelType = -1 # -1:unlabel; 0:pseudo; 1:true label
        ...
        self.update_timestamp = create_timestamp
        self.confidence =confidence #representativeness
        self.m = m
    ...
    def insert(self, new_point, current_timestamp, pred_idx=None):
        self.nb_points += 1
    ...
    def merge(self, micro_cluster):
        ...
        self.confidence = max(self.confidence, micro_cluster.confidence)
